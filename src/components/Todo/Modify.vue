      ...
      <div class="modal-card">
        ...
        <form @submit="OnSubmit">
          ...
          <h4>
            ...
            <input
              type="text"
              v-model="form.alarm_year"
              placeholder="alarm-year"
            />
            <input
              type="text"
              v-model="form.alarm_month"
              placeholder="alarm-month"
            />
            <input
              type="text"
            ...
            <input
              type="text"
              v-model="form.alarm_hour"
              placeholder="alarm-hour"
            />
            <input
              type="text"
              v-model="form.alarm_min"
              placeholder="alarm-min"
            />
          </h4>
